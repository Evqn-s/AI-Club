...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-[clamp(0.625rem,2vw,0.75rem)] py-[clamp(0.125rem,1vw,0.25rem)] text-fluid-label font-medium tracking-[0.06em] uppercase transition-colors",
  {
    variants: {
      variant: {
